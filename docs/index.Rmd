...
***NOTE: The zooplankton graph and data were incorrect due to a bug in the code. Mysid BPUE was incorrectly calculated and under-represented. Please use the corrected version, but [the original is here](Delta_Smelt_conditions_report_2018.html) for reference***
